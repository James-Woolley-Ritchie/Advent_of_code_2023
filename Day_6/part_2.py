...
def find_hand_type(hand):
    ...
    number_of_jokers = number_of_each_card.pop()
    number_of_each_card[number_of_each_card.index(max(number_of_each_card))] += number_of_jokers # Find the card with the most occurences. (if there are multiple with the same number this way will get the highest one)
